    ...
    <main className="min-h-screen bg-[#f5f5f7] px-6 py-24 text-black">
      <div className="mx-auto max-w-7xl">
        <div className="mb-12 flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-lg leading-8 text-neutral-500">
              Browse every furniture piece from Home Bliss, including sofas,
              beds, dining sets, storage, tables and premium living room
              essentials.
            </p>
          </div>
        ...
        {loading ? (
          ...
          <ProductGrid productsList={products} filterTitle="Explore collection" />
        )}
      </div>
    </main>
  );
